...
public class CDVFtp extends CordovaPlugin {
    ...
    public boolean execute(String action, final JSONArray args, final CallbackContext callbackContext) throws JSONException {
        if (action.equals("connect")) {
            cordova.getThreadPool().execute(new Runnable() {
                public void run() {
                    try {
                        connect(args.getString(0), args.getString(1), args.getString(2), args.getString(3), callbackContext);
                    } catch (Exception e) {
    ...
    private void connect(String hostname, String username, String password, String options, CallbackContext callbackContext) {
